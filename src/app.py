"""
MetaRecoverX Forensic Recovery Tool - Central Application Controller
...
Author: MetaRecoverX Development Team
Version: 1.0.0
"""
import logging
import json
...
class MetaRecoverXApp:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        """
        Initialize the MetaRecoverX application.
        ...
        self.logger.info("MetaRecoverX application initialized")
    ...
    def _setup_logging(self) -> logging.Logger:
        ...
        # Configure MetaRecoverX logger specifically
        logger = logging.getLogger("MetaRecoverX")
        logger.setLevel(log_level)
        
        # File handler with timestamp
        log_file = log_dir / f"MetaRecoverX_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
        ...
        # Don't add handlers to MetaRecoverX logger — it inherits from root via propagation.
    ...
    def _generate_json_report(self, session, all_files, report_path: Path):
        ...
        report = {
            "report_type": "MetaRecoverX Forensic Recovery Report",
    ...
    def _generate_pdf_report(self, session, all_files, report_path: Path):
        ...
        elements.append(Paragraph("MetaRecoverX Forensic Recovery Report", title_style))
    ...
    def _generate_text_report(self, session, all_files, report_path: Path):
        ...
        lines = []
        lines.append("=" * 60)
        lines.append("  MetaRecoverX Forensic Recovery Report")
        lines.append("=" * 60)
