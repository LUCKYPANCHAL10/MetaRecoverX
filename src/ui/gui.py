"""
MetaRecoverX Forensic Recovery Tool - GUI Interface
...
class MetaRecoverXGUI(QMainWindow):
    """Main MetaRecoverX GUI Application"""
    
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MetaRecoverX - Forensic Data Recovery")
    ...
    def create_dashboard_view(self):
        ...
        welcome_text = QLabel(
            "Welcome to MetaRecoverX Forensic Recovery\n\n"
...
def main():
    ...
    app.setApplicationName("MetaRecoverX")
    app.setOrganizationName("MetaRecoverX Forensics")
    
    apply_global_stylesheet(app)
    
    window = MetaRecoverXGUI()
    window.show()
